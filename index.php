...
<head>
    ...
    <meta name="keywords" content="desenvolvimento de software,software house,desenvolvimento mobile,software,desenvolvedor,desenvolvimento web,web,mobile,freelancer,projeto,tecnoligia," />
    <meta name="description" content="Matriz IT desenvolvendo ideias com tecnologia." />
    <meta name="Author" content="Matriz IT" />
...
<body>
    <!-- HOME/HEADER -->
    <section class="bg-home bg-color" style="position: relative;" id="grad home">
        ...
        <div class="container items-center">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="text-title-bg text-white">Inteligência
                        <br>em <i style="color: #FF3C00;">tecnologia</i>
                        <br>para seu negócio
                    </h1>
                    <br>
                    <p class="text-regular-white">Existimos para transformar a realidade ao nosso redor por meio da
                        tecnologia.
                        Somos especialistas em desenvolvimento de software e aplicativos.
                        <br> Contando com uma equipe qualificada de desenvolvedores,
                        designers, programadores, gestores de projeto e analistas de QA.
                        Nosso objetivo é atender desde as demandas simples até necessidades mais complexas e
                        específicas.
                    </p>
                    <br>
    ...
    <section style="background-color: #000021;">
        <div class="container" id="service">
            ...
            <div class="row">
                <div class="text-center text-white mt-5">
                    <span>
                        ...
                        <i class="text-bold" style="font-size: 40px;">Nossos serviços</i>
                        <p></p>
                    </span>
                    <br>
                </div>
            ...
            <div class="row mt-5">
                <div class="col-sm-4">
                    <div class="card" style="background-color: #09092E; ">

                        <!-- Estrategia -->
                        <div class="card-body text-center text-white mt-5 ">
                            <i class="text-center"><img src="assets/images/board-1.png" style="position: absolute;
                                top: 0;
                                left: 50%;
                                transform: translate(-50%, -50%);"></i>
                            <i class="text-bold" style="font-size: 20px;">Estratégia digital</i>
                            <div class="mt-3"></div>
                            <p class="card-text">Entendemos problemas e<br>apontamos caminhos
                            </p>
                            <!--  <button
                        class="btn button btn-outline-primary text-semi-bold">Saiba mais</button> -->
                        </div>

                    </div>
                    <h1 style="position:relative;top: -5px; border: solid 2px #FF3C00"></h1>
                </div>
                <div class="col-sm-4">
                    <div class="card" style="background-color: #09092E;">
                        ...
                        <div class="card-body text-center text-white mt-5">
                            ...
                            top: 0;
                            left: 50%;
                            transform: translate(-50%, -50%);"><img src="assets/images/board-2.png"></i>
                            <i class="text-bold" style=" font-size: 20px;">Outsourcing</i>
                            <div class="mt-3"></div>
                            <p class="card-text">Somos especilistas em<br>desenvolvimento
                            </p>
                            <!-- <button
                        class="btn button btn-outline-primary text-semi-bold">Saiba mais</button> -->
                        </div>
                    ...
                    <div class="card" style="background-color: #09092E;">
                        ...
                        <div class="card-body text-center text-white mt-5">
                            ...
                            <i class="text-bold" style="font-size: 20px;">Desenvolvimento <br>de
                                tecnologia</i>
                            <div class="mt-3"></div>
                            <p class="card-text">Criamos soluções <br>tecnológicas desafiadoras
                            </p>
                            <!--  <button
                        class="btn button btn-outline-primary text-semi-bold">Saiba mais</button> -->
                        </div>
    ...
    <section class=" bg-color responsivo responsivo-we tecnologia" id="grad ">
        <div class="container " id="tecno">
            ...
            <div class="container items-center">
                <div class="row ">
                    <div class="col-sm-12">
                        <a class=" text-center" onClick="changeDisplay('mobile')"><button class="btn btn-primary m-1" style="width: 150px;" type="button">Mobile</button></a>
                        <a class=" text-center" onClick="changeDisplay('front-end')"><button class="btn btn-primary m-1" style="width: 150px;" type="button">Front-end</button></a>
                        <a class=" text-center" onClick="changeDisplay('back-end')"><button class="btn btn-primary m-1" style="width: 150px;" type="button">Back-end</button></a>
                        <a class=" text-center" onClick="changeDisplay('dba')"><button class="btn btn-primary m-1" style="width: 150px;" type="button">Banco de
                                dados</button></a>
                        <!-- Mobile-->
            ...
            <div class="row">
                ...
                <div class="col-sm-6 ">
                    <div class="text-center">
                        <h1 class="text-title-bg text-white ">Quer fazer <br>um
                            <i style="color: #FF3C00;">projeto</i>
                            <br>conosco?
                        </h1>
                        <br>
                        <p class="text-regular-white">Preencha o formulário ao lado e responderemos<br> o mais breve
                            possível
    ...
    <section class="bg-color text-center text-white ">
        <div class="container p-4 pb-0">
            <!-- Section: Social media -->

            <!-- Instagram -->
            <a href="https://www.instagram.com/matrizit/" target="_blank">
                <i class="btn-floating m-0" role="button"><img style="width: 30px ;" src="assets/images/insta.png"></i>
            </a>

            <!-- 
            <i class="btn-floating m-0" href="#!" role="button"><img style="width: 20px ;"
                    src="https://matrizit.com.br/assets/images/face.png"></i> -->
